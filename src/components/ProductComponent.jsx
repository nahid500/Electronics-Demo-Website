...
const ProductComponent = () => {
    ...
    return (
        <div className="container mx-auto px-4 py-6">
            <h1 className="text-3xl font-bold text-center mb-6 text-cyan-900">Your One-Stop Tech Shop</h1>
                ...
                <div key={subcategory} className="mb-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                        {groupedProducts[subcategory].map((product) => (
                            <div key={product.id} className="max-w-sm rounded overflow-hidden shadow-lg bg-cyan-500 hover:bg-cyan-300 transition duration-300">
                                ...
                                <div className="px-6 py-4">
                                    ...
                                    <div className="mt-4 flex flex-col gap-2">
                                        ...
                                        <Link
                                            ...
                                            className="bg-gray-600 text-white py-2 px-4 rounded hover:bg-gray-800 transition-colors w-full text-center"
                                        >
                                            View Details
                                        </Link>
                                    </div>
